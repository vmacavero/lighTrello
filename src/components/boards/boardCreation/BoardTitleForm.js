...
let BoardTitleForm = (props) => {
    ...
    return (
        <div>
            ...
            <ButtonWrapper>
                <CancelButton onClick={() => cancelAction()}>Annulla</CancelButton>
                <SubmitButton onClick={handleSubmit} type="button">Crea ora !</SubmitButton>
            </ButtonWrapper>
        </div>
    )
}
...
function validate(values) {
    ...
    if (!values.boardTitle || values.boardTitle === '') {
        errors.boardTitle =  "Ricorda di inserire il nome"
    }
